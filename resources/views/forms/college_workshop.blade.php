<h2>Workshop form</h2>
<form action="/college/workshop/submit"  method="post" name="workshop_form" enctype="multipart/form-data">
  {{csrf_field()}}
  ...
  <div class="form-group">
    <label for="nofcan">No Of Students / Candidates:</label>
  ...
  <div class="form-group">
  <label for="lname">Need Placement Assistense:</label>
  <div class="radio">
    <label><input type="radio"  name="placement" value="1" />Yes</label>
    <label><input type="radio"  name="placement" value="0"  checked />No</label>
  </div>
</div>
<div class="form-group">
    <label for="images">Please Upload College Image</label>
