<h2>Classroom Training form</h2>
<form action="/classroom/training/submit"  method="post" name="workshop_form" enctype="multipart/form-data">
  {{csrf_field()}}
  <input type="hidden" name="enquiry_type" value="<?php echo base64_encode('classroom')?>">
